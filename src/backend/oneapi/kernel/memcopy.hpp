...
static convertType<char, compute_t<arrayfire::common::half>>(char value) {
    return compute_t<arrayfire::common::half>(value);
}

template<>
static unsigned char convertType<compute_t<arrayfire::common::half>, unsigned char>(
    compute_t<arrayfire::common::half> value) {
...
template<>
compute_t<arrayfire::common::half>
static convertType<unsigned char, compute_t<arrayfire::common::half>>(
    unsigned char value) {
    return compute_t<arrayfire::common::half>(value);
}
